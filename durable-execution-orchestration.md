...
- [The Three C's of Distributed Transactions](#the-three-cs-of-distributed-transactions)
...
Temporal's architecture makes specific choices for each C, and its design allows flexibility across others:
